...
How would solve a Jigsaw Puzzle?

## Typical Process

- Begin by trying to identify 2 pieces that are *similar* to each other and combine them (cluster).
- Then perhaps try finding another piece that is similar to existing clusters and combine.
- Continue this process of combiing pieces/clusters till the completion.
